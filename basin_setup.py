...
def add_proj(nc_obj, epsg, nc_to_copy):
    ...
    try:
        ...
        out.warn("Failed to get projection info from the internet...\n"
    ...
    out.msg("Adding coordinate system info to:")
...
def add_proj_from_web(epsg):
    ...
    Returns:
        map_meta: dictionary of attributes to add for spatial reference
    """
    out.msg("Retrieving projection information...")
